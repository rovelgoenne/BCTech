...
page 54322 "knkShort Text Proposal"
{
    PageType = PromptDialog;
    Extensible = false;
    IsPreview = true;
    Caption = 'Create project shorttext from Metadata';
    ...
    var
        ...
        Attempts: Integer;
    begin
        Response := KnkGenerateProposal.GenerateShortDescription(Longtext, ChatRequest, MaxLength, LanguageOptions, Tone);
    end;
